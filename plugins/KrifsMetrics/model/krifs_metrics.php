...
class KrifsMetrics
{
	...
	public static function get_assigned_tickets_count ($count_ignored_types = true, $user_id = null)
	{
	...
	public static function get_tot_tickets_times($filter)
	{
	...
	public static function get_tot_irs_times($filter)
	{
	...
	public static function get_oldest_tickets_dates ($user_id = null)
	{
	...
	public static function get_created_tickets_details ($date_start, $date_end)
	{
		$ret = array ();
	...
	public static function get_closed_tickets ($date_start, $date_end, &$tot_closed_tickets)
	{
		$ret = array ();
	...
	public static function get_work_times ($date_start, $date_end)
	{
		$ret = array ();
	...
	function get_total_work_times($date_start, $date_end)
	{
		...
		$wts = self::get_work_times($date_start, $date_end);
		$timesheets = array();
		foreach($wts as $uid=>$wt)
		{
			$um = self::get_user_metrics($uid, $date_start, $date_end);
			$uts = array();
			foreach($um as $m)
			{
	...
	public static function get_average_closing_time ($date_start, $date_end)
	{
		$ret = array ();
		$date_start = get_first_hour ($date_start);
		$date_end = get_last_hour ($date_end);
	...
	public static function get_user_metrics ($user_id, $date_start, $date_end)
	{
	...
	public static function get_cust_open_tickets_count($count_ignored_types = true)
	{
		if ($count_ignored_types)
		{
	...
	public static function get_cust_created_tickets($date_start, $date_end)
	{
		$ret = array ();
	...
	public static function get_cust_closed_tickets ($date_start, $date_end, &$tot_closed_tickets)
	{
		$ret = array ();
	...
	public static function get_cust_oldest_tickets_dates ()
	{
	...
	public static function get_cust_average_closing_time ($date_start, $date_end)
	{
		$ret = array ();
		$date_start = get_first_hour ($date_start);
		$date_end = get_last_hour ($date_end);
	...
	public static function get_cust_tickets_stats ()
	{
		$ret = array ();
		$tmp_stats = array ();
