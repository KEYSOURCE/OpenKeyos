...
{assign var="paging_titles" value="KRIFS, Timesheets, Edit Timesheet, Add Timesheet Detail"}
{assign var="paging_urls" value="/krifs, /manage_timesheets, /krifs/timesheet_edit/"|cat:$timesheet_id}
{include file="paging.html"}

<h1>Add Timesheet Detail: {$timesheet->date|date_format:$smarty.const.DATE_FORMAT_SMARTY}, {$timesheet->user->get_name()}</h1>
