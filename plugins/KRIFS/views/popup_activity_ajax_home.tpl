...
{
        var frm = document.getElementById(frm_name);//document.forms[frm_name];
        var time_in = date_time_to_ts(frm.elements[date_in_name].value, frm.elements[hour_in_name].value);
        var time_out = date_time_to_ts(frm.elements[date_out_name].value, frm.elements[hour_out_name].value);
        
        frm.elements[start_travel_to_name].value = date_time_to_ts(frm.elements[date_out_name].value, frm.elements[start_travel_to_name].value);
        frm.elements[end_travel_to_name].value = date_time_to_ts(frm.elements[date_out_name].value, frm.elements[end_travel_to_name].value);
        frm.elements[start_travel_from_name].value = date_time_to_ts(frm.elements[date_out_name].value, frm.elements[start_travel_from_name].value);
        frm.elements[end_travel_from_name].value = date_time_to_ts(frm.elements[date_out_name].value, frm.elements[end_travel_from_name].value);

        var data = unescape($("#frm_t").serialize());
        data = data + '&detail[time_in]=' +time_in;
        data = data + '&detail[time_out]=' +time_out;
        
        $.post('/krifs/ticket_detail_edit_submit_ajax?save=true', data, function(data) {
...
{$form_redir}
<input type="hidden" value="{$ticket_detail_id}" name="ticket_detail_id"/>
...
<input type="submit" name="cancel" id="cancel" value="Cancel" onclick="top.$.fancybox.close();return false;" />
&nbsp;&nbsp;&nbsp;
