...
{assign var="paging_titles" value="KRIFS, Ticket, Add Schedule"}
...
<table class="list" width="98%">
	...
	<tr>
		...
		<td width="40%" class="post_highlight"># {$ticket->id} : {$ticket->subject|escape}</td>
	...
	<tr>
		<td class="highlight" nowrap="nowrap">Relative priority:</td>
		<td class="post_highlight">
			<select name="task[ord]">
				<option value="9999">Top</option>
				<option value="-1" {if $task->ord==-1}seleted{/if}>Bottom</option>
			</select>
		</td>
		<td class="highlight" nowrap="nowrap">Percent completed:</td>
		<td class="post_highlight">
	...
	<tr>
		...
		<td class="post_highlight">
			...
			{if $customers_locations_list}
				<select name="task[customer_location_id]">
					<option value="">---</option>
