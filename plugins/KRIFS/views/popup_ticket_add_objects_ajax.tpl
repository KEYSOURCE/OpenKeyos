...
var selected_objects = top.getLinkedObjects ();
...
{
	top.setLinkedObjects (selected_objects);
	top.$.fancybox.close();
        return false;
}
...
{/if}
<input type="submit" name="cancel" value="Cancel" onclick="top.$.fancybox.close(); return false;" />
&nbsp;&nbsp;&nbsp;
{if count($all_objects) > 0}
