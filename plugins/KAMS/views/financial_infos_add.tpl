{assign var="paging_titles" value="KAMS, Manage Assets, Edit Asset, Add Financial Informations"}
...
<table class="list" width="95%">
	...
	<tr>
		...
		<td width="70%"><input type="text" name="fin_infos[invoice_number]" value="" /></td>
		<td width="10%">&nbsp;</td>
	</tr>
	<tr>
		<td width="20%">Invoice date</td>
		<td width="70%"><input type="text" size="12" name="fin_infos[invoice_date]" value="">
	...
	<tr>
		...
		<td width="70%">
			...
			{html_options options=$suppliers selected=0}
			</select>
		</td>
	</tr>
	<tr>
		...
		<td width="70%">
			<select id='currency' name="fin_infos[currency]" onchange="change_currency_symbol()">
				{html_options options=$currencies selected=1}
			</select>
		</td>
	</tr>
	<tr>
		<td width="20%">Purchase value</td>
		<td	width="70%"><input type="text" class="currency_input" name="fin_infos[purchase_value]" value="0" />  <div style="display: inline;" id="currency_sy1">{$currency_symbols[1]}</div></td>
		<td width="10%">&nbsp;</td>
	</tr>
	<tr>
		<td width="20%">Write-off value</td>
		<td width="70%"><input type="text" class="currency_input" name="fin_infos[writeoff_value]" value="0" />  <div style="display: inline;" id="currency_sy2">{$currency_symbols[1]}</div></td>
	</tr>
	<tr>
		<td width="20%">Amortization period</td>
		<td width="70%"><input type="text" style="text-align: right; width: 80px;" name="fin_infos[amortization_period]" value="0" />  days</td>
		<td width="10%">&nbsp;</td> 
	</tr>
