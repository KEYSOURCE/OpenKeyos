...
class CustomerOrder extends Base
{
	...
	*						their subjects
	*/
	public static function get_open_orders_list($customer_id)
	{
		$ret = array ();
		if ($customer_id)
		{
	...
	*/
	public static function get_orders_list ($filter = array())
	{
		$ret = array ();
	...
	*/
	public static function get_orders ($filter = array(), &$cnt)
	{
		$ret = array ();
