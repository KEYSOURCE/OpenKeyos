{assign var="paging_titles" value="KAWACS, Manage Peripherals, Edit Peripheral"}
{assign var="paging_urls" value="/?cl=kawacs, /?cl=kawacs&op=manage_peripherals"}
...
<table width="95%" class="list">
	...
	<tr>
		...
		<td class="post_highlight">
			<a href="/?cl=customer&amp;op=customer_photo_add&amp;peripheral_id={$peripheral->id}&amp;returl={$ret_url}">Add photo &#0187;</a>
	...
	<tr>
		...
		<td class="post_highlight">
			...
			/>
			{literal}
			<a href="#" onclick="showCalendarSelector('edit_frm', 'peripheral[date_created]'); return false;" name="anchor_calendar" id="anchor_calendar"
	...
	<tr>
		...
		<td class="post_highlight">
			...
			{/if}
			&nbsp;&nbsp;<a href="/?cl=kawacs&op=peripheral_location&id={$peripheral->id}"
		...
		<thead>
			<tr>
				...
				<td align="right" nowrap="nowrap">
					...
					<a href="/?cl=kawacs&amp;op=peripheral_edit_snmp&amp;id={$peripheral->id}&amp;returl={$ret_url}">Edit SNMP settings &#0187;</a>
					{/if} 
				</td>
			</tr>
		</thead>
