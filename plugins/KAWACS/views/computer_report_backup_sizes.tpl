{assign var="paging_titles" value="KAWACS, Manage Computers, View Computer, Backups Size"}
...
<img src="{'kawacs'|get_link:'plot_backup_size':$p:'template'}" width="600" height="400">
