{assign var="paging_titles" value="Technical Support, Ticket"}
...
<table class="list" width="98%">
	<thead>
	<tr>
		<td width="120"><b>Subject:</b></td>
		<td class="post_highlight" colspan="3"><b>{$ticket->subject}</b></td>
	</tr>
	</thead>
	
	<tr>
		<td class="highlight" width="120">Created: </td>
	...
	<tr class="head">
		...
		<td class="post_highlight" colspan="3">
			{if !$is_closed}
				[ <a href="/?cl=customer_krifs&op=ticket_attachment_add&ticket_id={$ticket->id}">Add attachment &#0187;</a> ]
			{/if}
		</td>
	</tr>
	...
	{else}
		<tr>
			<td> </td>
			<td colspan="3" class="post_highlight"><font class="light_text">[No attachments]</font></td>
		</tr>
	{/if}
	...
	<tr class="no_print">
		...
		<td class="post_highlight" colspan="3">
			...
			{else}
				<input type="submit" name="mark_closed" value="Mark as closed"
					onClick="return confirm('Are you sure you want to mark this ticket as closed?');" />
			{/if}
			&nbsp;&nbsp;&nbsp;
		...
		<tr>
			...
			<td colspan="3">
				{if $detail->comments}
					{$detail->comments}
				{else}
					<font class="light_text">[No comments]</font>
				{/if}
			</td>
		</tr>
	{/if}
...
{if !$is_closed}
	...
	<table class="list" width="98%">
                <tr>
                    <td width="120" class="highlight">Reassign to:</td>
                    <td style="text-align: left;">		
		...
		<tr>
			<td width="120" class="highlight">Comments:</td>
			<td>
	...
	<p/>
	<input type="submit" name="add_entry" value="Add comments / Save" class="button" />&nbsp;&nbsp;&nbsp;
	<input type="submit" name="cancel" value="Exit" class="button" />
	</div>
{/if}
