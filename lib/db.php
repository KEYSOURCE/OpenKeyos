...
class Db
{
    ...
    public static function db_query($q = '')
    {
        ...
        if ($q)
        {
            ...
            {
                $msg = 'Query error: ' . mysqli_error($GLOBALS['db_link']) . '; query: '.$q;
    ...
    public static function db_fetch_row ($q = '')
    {
        ...
        if ($q)
        {
            ...
            if (mysqli_error($GLOBALS['db_link']))
            {
                do_log ('Query error: '.$q.'<br/>:: '.mysqli_error($GLOBALS['db_link']), LOG_LEVEL_ERRORS);
            }
    ...
    public static function db_fetch_vector ($q = '')
    {
        ...
        if ($q)
        {
            ...
            if($h){
                if (mysqli_error($GLOBALS['db_link']))
                {
                    do_log ('Query error: '.$q.' :: '.mysqli_error($GLOBALS['db_link']), LOG_LEVEL_ERRORS);
                }
    ...
    public static function db_get_next ($h = null)
    {
        ...
        if ($h)
        {
            ...
            if (mysqli_error($GLOBALS['db_link']))
            {
                do_log ('Query error: '.mysqli_error($GLOBALS['db_link']), LOG_LEVEL_ERRORS);
            }
        }
        return $ret;
    }
    ...
    public static function get_client_encoding(){
        return mysqli_client_encoding($GLOBALS['db_link']);
    }
