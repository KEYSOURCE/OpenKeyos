...
const KS_CUSTOMER_ID = 6
const KS_SERVER_URL = "http://fortelogics.iasi.rdsnet.ro/keyos/kawacs.php"
const KS_COMPUTER_TYPE = 5
const KS_COMPUTER_PROFILE = 3
const KS_REPORT_INTERVAL = 120
const strUrl = "http://fortelogics.iasi.rdsnet.ro/keyos/updates/kawacs_agent/33/kawacs_agent.zip"
const zipLibUrl = "http://fortelogics.iasi.rdsnet.ro/keyos/XZip.dll"
...
downloadFile strUrl, strDestFile
