	...
	var form_widget_amount_slider_handle = 'images/color_picker/slider_handle.gif';
		...
		do{			
			if(subDiv.tagName=='DIV' && subDiv.className!='colorPickerCloseButton'){
				if(subDiv==thisObj){
					...
					img.src = "images/color_picker/tab_right_active.gif"
					...
					img.src = "images/color_picker/tab_right_inactive.gif";
					if(activeColorDiv)
	...
	function createColorPickerTopRow(inputObj){
		...
		for(var no=0;no<tabs.length;no++){			
			...
			tabImg.src = "images/color_picker/tab_right_" + suffix + ".gif";
